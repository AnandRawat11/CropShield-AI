                                ...
                                >
                                    {isQualityError ? (
                                        <div className="flex flex-col items-center justify-center text-center py-8">
                                            ...
                                            <h3 className="text-2xl font-bold text-white mb-3">Quality Error</h3>
                                            <p className="text-white/60">
                                                The AI could not confidently identify a crop or disease in this image.
                                                Please ensure you upload a clear, focused photo of a plant leaf.
                                            </p>
                                        </div>
                                    ) : (
                                        <>
